    ...
    <div className={classNames(className, classes.root)}>
      <Typography component="div" variant="body2">
        ...
        <p>
          ...
          works, faith is dead. James 1:22 tells us to guard against deception
        ...
        <p>
          ...
          implies action, rather than inactive belief. How then does one "obey"
          or "do" the gospel?{' '}
        </p>

        <p>
          Some argue that an individual can do nothing more than believe, repent
          and accept Jesus as Savior. Of a truth, that is indeed all that the
          sinner can do. However, careful consideration will find that this view
          stops short of the full counsel of God's Word. Peter's reply was
          threefold. The question was, "What must we do?" The answer referenced
          the doing of three things. Peter's admonition to "Repent" implies the
          concept of faith, belief, turning from sin, dying to self, etc., thus
          obeying Christ's death. However, that still leaves two additional
          commands, equally important in this biblical prescription for a
          sin-stricken heart.
        </p>

        <p>
          We must also obey his burial. We do this as we submit to the Church
          baptizing us into Christ and for the remission of our sins, calling on
          the saving name of Jesus. "For there is none other name under heaven
          given among men, whereby we must be saved". Acts 4:12.{' '}
        </p>

        <p>
          Finally, we must obey his resurrection. This is done as we yield
          ourselves to the infilling of God's spirit. "... if the Spirit of him
        ...
        <p>
          In summary the individual must obey Christ's death in repentance, his
          burial in baptism and his resurrection in the infilling of the spirit.
          From another perspective, in the work of salvation, there is something
          that the individual does (repent), something the Church does
          (baptize), and something that God does (fill with the Spirit).
        </p>
